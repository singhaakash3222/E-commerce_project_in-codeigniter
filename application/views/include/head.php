                    ...
                    <ul>
                        ...
                        <?php
                            if(isset($_SESSION['email'])){
                                if(!$_SESSION['email'] == ''){
                                    ?>
                                    <li style="float: right;"><a href="<?php echo base_url() ?>Cart/viewCart"><i class="fa fa-shopping-cart"></i> My Cart</a></li>
                                    <?php
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="<?php echo base_url() ?>Welcome">Mobile<span> River</span></a></h1>
                </div>
            </div>
